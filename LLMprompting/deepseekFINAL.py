...
# MODEL SETTINGS
# =====================
MODEL_NAME = "deepseek-ai/deepseek-coder-7b-instruct"  # or another DeepSeek model
TEST_DATA_PATH = "sms_test.csv"
OUTPUT_CSV = "DeepSeek_Spam_Output.csv"
MAX_NEW_TOKENS = 4
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    load_in_8bit=True  # Helps save GPU memory
)
model.eval()
...
print(f"Saved DeepSeek inference results to {OUTPUT_CSV}")
